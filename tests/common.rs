...
pub fn get_test_data() -> (Vec<Vec<f64>>, Vec<Vec<u32>>, Vec<u32>, Vec<Store>) {
    #[rustfmt::skip]
        let prices = vec![
            vec![ 13000.0, 5000.0, 2000.0, 4000.0, 6000.0, 7500.0, 8000.0, 3000.0, 9000.0, 8000.0, 2500.0, 2000.0, 4000.0, 4000.0, 5000.0, 400.0 ],
            vec![ 12000.0, 6000.0, 3000.0, 5000.0, 7000.0, 6000.0, 9000.0, 1000.0, 2000.0, 8500.0, 1500.0, 4000.0, 3000.0, 4200.0, 5500.0, 500.0 ],
            vec![ 14000.0, 5500.0, 2500.0, 3000.0, 8000.0, 7000.0, 6000.0, 2000.0, 6000.0, 9000.0, 2000.0, 2500.0, 4500.0, 4400.0, 4000.0, 600.0 ],
        ];
    let stocks = vec![
